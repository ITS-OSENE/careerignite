...
1. Copy `.env.local.example` to `.env.local` and add your Google OAuth values.
2. Create an OAuth client with application type **Web application** in Google Cloud Console.
